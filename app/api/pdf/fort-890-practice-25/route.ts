...
export async function GET() {
  try {
    ...
    page.drawText('Foundations of Reading 890 · Free Practice Test', { x: MARGIN, y: PAGE_H - 46, size: 15, font: bold, color: WHITE })
    ...
    return new NextResponse(Buffer.from(pdfBytes), {
      headers: {
        ...
        'Content-Disposition': 'attachment; filename="FORT-890-Practice-Test-25-Questions.pdf"',
        'Cache-Control': 'no-store',
      },
    })
  } catch (err) {
    console.error('FORT 890 Practice Test PDF error:', err)
