...
export const studyGuideQuizzes: Record<'I' | 'II' | 'III', QuizQuestion[]> = {
  I: [
    ...
    },
    {
      ...
      options: {
        A: 'Blending → Segmentation → Manipulation',
        B: 'Manipulation → Blending → Segmentation',
    ...
    },
    {
      ...
      options: {
        ...
        B: 'The ability to recognize all 26 letters by name and shape',
        C: 'The knowledge that print is read from left to right and top to bottom',
        D: 'The understanding that letters and letter combinations systematically represent spoken sounds',
      },
      correct: 'D',
    ...
    },
    {
      ...
      options: {
        A: 'Presents letter-sound patterns in a deliberate sequence from simple to complex',
        B: 'Teaches letter-sound correspondences only when students ask about them',
        C: 'Uses authentic literature rather than decodable text',
    ...
    },
    {
      ...
      options: {
        A: 'Words correct per minute (WCPM) oral reading fluency measure',
        B: 'Phonemic awareness probe',
        C: 'Phonics screening assessment',
  ...
  II: [
    {
      ...
      options: {
        A: 'Direct vocabulary instruction',
        B: 'Contextual word analysis strategies',
        C: 'Incidental vocabulary learning through context',
    ...
    },
    {
      ...
      options: {
        ...
        C: 'Critical evaluation of an author\'s craft',
        D: 'Narrative text structure',
      },
      correct: 'D',
    ...
    },
    {
      ...
      options: {
        ...
        D: 'Critical reading of informational text',
      },
      correct: 'D',
    ...
    },
    {
      ...
      options: {
        A: 'KWL (Know / Want to Know / Learned) chart',
        B: 'Oral reading fluency (WCPM) probe',
        C: 'Running record',
        D: 'Phonics screening',
      },
      correct: 'A',
    ...
    },
    {
      ...
      options: {
        ...
        B: 'Complete comprehension worksheets after every reading assignment',
        C: 'Use one strategy for all types of text',
        D: 'Apply strategies independently and flexibly to make meaning from text',
      },
      correct: 'D',
    ...
    },
    {
      ...
      options: {
        ...
        B: 'Writing practice improves phonics automaticity',
        C: 'It requires students to organize, synthesize, and express meaning',
  ...
  III: [
    ...
    },
    {
      ...
      options: {
        A: 'Identify precisely which phonics patterns the student has and has not mastered',
        B: 'Rank all students from highest to lowest reading ability',
    ...
    },
    {
      ...
      options: {
        ...
        B: 'Is only administered by reading specialists, not classroom teachers',
        C: 'Provides a single snapshot of where a student is performing',
        D: 'Is given frequently to students receiving intervention to track response to instruction',
      },
      correct: 'D',
    ...
    },
    {
      ...
      options: {
        A: 'Differentiated instruction based on current instructional level',
        B: 'Permanent tracking that limits student growth',
    ...
    },
    {
      ...
      options: {
        ...
        B: 'Any high-interest text regardless of phonics complexity',
        C: 'Leveled readers at the student\'s frustration level',
        D: 'Decodable text controlled for the specific phonics patterns taught',
      },
      correct: 'D',
    ...
    },
    {
      ...
      options: {
        ...
        B: 'Continue the same instruction without modification',
    ...
    },
    {
      ...
      options: {
        A: 'Progress monitoring student growth over time',
        B: 'Ranking students for report card grades',
        C: 'Diagnosing specific phonics skill gaps',
    ...
    },
    {
      ...
      options: {
        ...
        B: 'Fluency instruction exclusively, since fluency bridges decoding and comprehension',
        C: 'Decoding instruction, since decoding is the prerequisite for comprehension in early reading',
